...
app.get("/old-data", (req, res) => {
  ...
  connectionPool.getConnection((err, connection) => {
    ...
    const sql = "SELECT old_id, old_question, old_answer, timestamp FROM old_qna ORDER BY id DESC LIMIT 50" // 50 Old klausimu siuncia i quiz.js
...
// Start a Node.js Script: pm2 start pm2.config.json
