...
if (isset($_SESSION['nick_name'])) {
    ...
    echo "<link rel='stylesheet' type='text/css' href='/viktorina-v2/app/statistics/statistics.css'>";
  ...
  session_unset();  
  session_destroy();
  // header('Refresh: 12; URL= login.php');
  ...
  echo "<script>window.location.href = '/viktorina-v2/app/login.php';</script>";
}
