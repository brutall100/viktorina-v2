...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="page-mistake.css">
...
<body>
    ...
    <div class="form-wrapper">
        <h2>Pranešti apie klaidą <img src="/viktorina-v2/images/icons/info.webp" alt="Info" id="info-icon">
        </h2>
        ...
        <form action="page-mistake-form.php" method="POST">
...
<script type="text/javascript" src="page-mistake.js" defer></script>
