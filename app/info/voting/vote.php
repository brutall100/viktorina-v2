...
<body>
    ...
    <main class="main-content">                                            <!-- Main vote [ Imported from update-main-vote.php ] -->
        ...
        <div class="right-sections">                                       <!-- Vote suggestions -->
            ...
            <section id="vote-suggestions" class="vote-suggestions">
                <form action="vote-form.php" method="post" class="vote-suggestion-form">
            ...
            <section id="view-suggestions" class="view-suggestions">       <!-- Wiev suggestions [ Imported from update-vote.php ] -->
...
<script type="text/javascript" src="vote.js" defer></script>
</html>