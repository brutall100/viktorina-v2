...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="question-mistake.css">
    ...
    <main>
        <div class="container-a">
            <div class="form-wrapper">
                <h2>Pranešti apie klaidą klausime <img src="/viktorina-v2/images/icons/info.webp" alt="Info" id="info-icon" aria-label="Info ženkliukas informuojantis kad šiame puslapyje galima pataisyti ar patobulinti esamus klausimus."></h2>
                ...
                <form action="question-mistake-form.php" method="POST">
...
<script type="text/javascript" src="question-mistake.js" defer></script>
</html>
